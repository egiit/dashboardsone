export const QueryWeekRep = (params) => {
  ...
  return `SELECT n.SCHD_ID, n.SCH_ID, n.SCHD_PROD_DATE, n.ID_SITELINE,  n.SITE_NAME, n.CUS_NAME, n.LINE_NAME, n.SHIFT,
  ...
  FROM (
      SELECT 
      a.SCHD_ID, a.SCH_ID, a.SCHD_PROD_DATE, a.ID_SITELINE,  a.SITE_NAME, b.CUS_NAME, a.LINE_NAME, a.SHIFT, 
    ...
    WHERE  (a.PLAN_WH <> '0' OR a.TOTAL_TARGET <> '0.0') 
    AND  ${params}
