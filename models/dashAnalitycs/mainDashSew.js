...
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.CUS_NAME, h.LINE_NAME, h.SHIFT, h.SCHD_QTY,
        ...
        h.WH_PERCENTAGE
        FROM(
					 SELECT a.*, (a.PLAN_WH/ f.PLAN_WH) WH_PERCENTAGE , b.CUS_NAME,    d.ORDER_REFERENCE_PO_NO,  c.SCHD_DAYS_NUMBER,
					  d.ORDER_NO, d.CUSTOMER_NAME, d.CUSTOMER_PROGRAM, d.PRODUCT_ITEM_CODE, 
					  d.ITEM_COLOR_CODE,  d.ITEM_COLOR_NAME, d.ORDER_STYLE_DESCRIPTION, b.FOREMAN
					FROM log_daily_output a 
					LEFT JOIN item_siteline b ON b.ID_SITELINE = a.ID_SITELINE
					LEFT JOIN weekly_prod_sch_detail c ON c.SCHD_ID = a.SCHD_ID
					...
					WHERE a.SCHD_PROD_DATE = CURDATE() AND a.SHIFT = 'Normal_A'
        )h
...
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.CUS_NAME, h.LINE_NAME, h.SHIFT, h.SCHD_QTY,
        ...
        FROM(
					...
					WHERE a.SCHD_PROD_DATE = CURDATE() AND a.SHIFT = 'Shift_A'
        )h
...
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.CUS_NAME, h.LINE_NAME, h.SHIFT, h.SCHD_QTY,
        ...
        FROM(
					...
					WHERE a.SCHD_PROD_DATE = CURDATE() AND a.SHIFT = 'Shift_B'
        )h
