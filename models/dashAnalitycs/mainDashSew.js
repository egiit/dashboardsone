...
I.TOTAL_TARGET,
-- FIND_RTT(I.FT_NORMAL, I.LT_NORMAL, :schDate, I.ACT_TARGET, 	 I.ACT_TARGET/I.PLAN_WH, 'Normal_A') RTT,
-- FIND_RTT_OT(gl.SHIFT_END_HOUR, I.LT_OT, :schDate, ACT_TARGET_OT, ACT_TARGET_OT/PLAN_WH_OT) RTT_OT, 
-- FIND_RTT_OT(gl.SHIFT_HOURLY_OT2, I.LT_X_OT, :schDate, ACT_TARGET_X_OT, ACT_TARGET_X_OT/PLAN_WH_X_OT) RTT_X_OT,
FIND_RTT(gl.SHIFT_START_HOUR, gl.SHIFT_END_HOUR, :schDate, I.ACT_TARGET, 	 I.ACT_TARGET/I.PLAN_WH, 'Normal_A') RTT,
        ...
        SELECT n.SCHD_ID, n.SCH_ID, n.SCHD_PROD_DATE, n.ID_SITELINE,  n.SITE_NAME,  n.CUS_NAME, n.LINE_NAME, n.SHIFT, n.SCHD_QTY,
            ...
            FROM (
                    ...
                    LEFT JOIN (
                             ...
                             WHERE a.ENDLINE_SCHD_DATE = :schDate AND b.SHIFT = 'Normal_A' -- AND a.ENDLINE_ID_SITELINE =  'SLD0000001'
...
I.ACT_MP_X_OT, I.ACT_TARGET_X_OT,
I.TOTAL_TARGET,
-- FIND_RTT(I.FT_NORMAL, I.LT_NORMAL, :schDate, I.ACT_TARGET, 	 I.ACT_TARGET/I.PLAN_WH, 'Shift_A') RTT,
-- FIND_RTT_OT(gl.SHIFT_END_HOUR, I.LT_OT, :schDate, ACT_TARGET_OT, ACT_TARGET_OT/PLAN_WH_OT) RTT_OT, 
-- FIND_RTT_OT(gl.SHIFT_HOURLY_OT2, I.LT_X_OT, :schDate, ACT_TARGET_X_OT, ACT_TARGET_X_OT/PLAN_WH_X_OT) RTT_X_OT,
FIND_RTT(gl.SHIFT_START_HOUR, gl.SHIFT_END_HOUR, :schDate, I.ACT_TARGET, 	 I.ACT_TARGET/I.PLAN_WH, 'Shift_A') RTT,
FIND_RTT_OT(gl.SHIFT_END_HOUR, DATE_ADD(gl.SHIFT_END_HOUR, INTERVAL I.PLAN_WH_OT MINUTE), :schDate, ACT_TARGET_OT, ACT_TARGET_OT/PLAN_WH_OT) RTT_OT, 
FIND_RTT_OT(gl.SHIFT_HOURLY_OT2, DATE_ADD(gl.SHIFT_END_HOUR, INTERVAL I.PLAN_WH_X_OT MINUTE), :schDate, ACT_TARGET_X_OT, ACT_TARGET_X_OT/PLAN_WH_X_OT) RTT_X_OT,
I.NORMAL_OUTPUT,  I.OT_OUTPUT, I.X_OT_OUTPUT, I.TOTAL_OUTPUT,  
I.PLAN_EH, I.PLAN_AH, I.PLAN_EH_OT, I.PLAN_AH_OT,  I.PLAN_EH_X_OT, I.PLAN_AH_X_OT,
...
I.ACTUAL_EH_X_OT,IF(I.ACTUAL_AH_X_OT < PLAN_AH_X_OT, PLAN_AH_X_OT, ACTUAL_AH_X_OT)ACTUAL_AH_X_OT
FROM (
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.LINE_NAME,  h.CUS_NAME, h.SHIFT, h.SCHD_QTY,
        h.ORDER_REFERENCE_PO_NO, h.FOREMAN, h.SCHD_DAYS_NUMBER, 
        h.ORDER_NO, h.CUSTOMER_NAME, h.CUSTOMER_PROGRAM, h.PRODUCT_ITEM_CODE, 
        h.ITEM_COLOR_CODE,  h.ITEM_COLOR_NAME, h.ORDER_STYLE_DESCRIPTION, 
        h.PLAN_SEW_SMV, h.FT_NORMAL,  h.LT_NORMAL, h.FT_OT, h.LT_OT,  h.FT_X_OT, h.LT_X_OT,
        ...
        (h.X_OT_OUTPUT*h.PLAN_SEW_SMV) ACTUAL_EH_X_OT, (h.ACT_MP_X_OT*h.ACT_WH_X_OT)  ACTUAL_AH_X_OT
        FROM(
        SELECT n.SCHD_ID, n.SCH_ID, n.SCHD_PROD_DATE, n.ID_SITELINE,  n.SITE_NAME, n.LINE_NAME,  n.CUS_NAME, n.SHIFT, n.SCHD_QTY,
                n.ORDER_REFERENCE_PO_NO, n.FOREMAN, n.SCHD_DAYS_NUMBER, 
                n.ORDER_NO, n.CUSTOMER_NAME, n.CUSTOMER_PROGRAM, n.PRODUCT_ITEM_CODE, 
                n.ITEM_COLOR_CODE,  n.ITEM_COLOR_NAME, n.ORDER_STYLE_DESCRIPTION,  
                n.SEQ_NORMAL, n.SEQ_OT,	n.PLAN_SEW_SMV, n.PLAN_MP, n.PLAN_WH, n.ACT_MP, 
            ...
            FROM (
                    ...
                    LEFT JOIN (
                             ...
                             FROM qcendlineoutput a 
                             LEFT JOIN item_siteline b ON a.ENDLINE_ID_SITELINE = b.ID_SITELINE
                             WHERE a.ENDLINE_SCHD_DATE = :schDate AND b.SHIFT = 'Shift_A' -- AND a.ENDLINE_ID_SITELINE =  'SLD0000001'
                    ) p ON a.SCHD_ID = p.ENDLINE_ACT_SCHD_ID
                    LEFT JOIN out_prod_time_view l ON l.ENDLINE_ACT_SCHD_ID = a.SCHD_ID AND l.ENDLINE_ID_SITELINE = e.ID_SITELINE AND l.ENDLINE_SCHD_DATE = :schDate
...
I.ACT_MP_X_OT, I.ACT_TARGET_X_OT,
I.TOTAL_TARGET,
-- FIND_RTT(I.FT_NORMAL, I.LT_NORMAL, :schDate, I.ACT_TARGET, 	 I.ACT_TARGET/I.PLAN_WH, 'Shift_B') RTT,
-- FIND_RTT_OT(gl.SHIFT_END_HOUR, I.LT_OT, :schDate, ACT_TARGET_OT, ACT_TARGET_OT/PLAN_WH_OT) RTT_OT, 
-- FIND_RTT_OT(gl.SHIFT_HOURLY_OT2, I.LT_X_OT, :schDate, ACT_TARGET_X_OT, ACT_TARGET_X_OT/PLAN_WH_X_OT) RTT_X_OT,
FIND_RTT(gl.SHIFT_START_HOUR, gl.SHIFT_END_HOUR, :schDate, I.ACT_TARGET, 	 I.ACT_TARGET/I.PLAN_WH, 'Shift_B') RTT,
FIND_RTT_OT(gl.SHIFT_END_HOUR, DATE_ADD(gl.SHIFT_END_HOUR, INTERVAL I.PLAN_WH_OT MINUTE), :schDate, ACT_TARGET_OT, ACT_TARGET_OT/PLAN_WH_OT) RTT_OT, 
FIND_RTT_OT(gl.SHIFT_HOURLY_OT2, DATE_ADD(gl.SHIFT_END_HOUR, INTERVAL I.PLAN_WH_X_OT MINUTE), :schDate, ACT_TARGET_X_OT, ACT_TARGET_X_OT/PLAN_WH_X_OT) RTT_X_OT,
I.NORMAL_OUTPUT,  I.OT_OUTPUT, I.X_OT_OUTPUT, I.TOTAL_OUTPUT,  
I.PLAN_EH, I.PLAN_AH, I.PLAN_EH_OT, I.PLAN_AH_OT,  I.PLAN_EH_X_OT, I.PLAN_AH_X_OT,
        ...
        SELECT n.SCHD_ID, n.SCH_ID, n.SCHD_PROD_DATE, n.ID_SITELINE,  n.SITE_NAME, n.LINE_NAME,  n.CUS_NAME, n.SHIFT, n.SCHD_QTY,
            ...
            FROM (
                    ...
                    LEFT JOIN (
                             ...
                             FROM qcendlineoutput a 
                             LEFT JOIN item_siteline b ON a.ENDLINE_ID_SITELINE = b.ID_SITELINE
                             WHERE a.ENDLINE_SCHD_DATE = :schDate AND b.SHIFT = 'Shift_B' -- AND a.ENDLINE_ID_SITELINE =  'SLD0000001'
                    ) p ON a.SCHD_ID = p.ENDLINE_ACT_SCHD_ID
                    LEFT JOIN out_prod_time_view l ON l.ENDLINE_ACT_SCHD_ID = a.SCHD_ID AND l.ENDLINE_ID_SITELINE = e.ID_SITELINE AND l.ENDLINE_SCHD_DATE = :schDate
...
I.ACT_MP_X_OT, I.ACT_TARGET_X_OT,
I.TOTAL_TARGET,
 FIND_RTT(gl.SHIFT_START_HOUR, gl.SHIFT_END_HOUR, :schDate, I.ACT_TARGET, 	 I.ACT_TARGET/I.PLAN_WH, :shift) RTT,
 FIND_RTT_OT(gl.SHIFT_END_HOUR, DATE_ADD(gl.SHIFT_END_HOUR, INTERVAL I.PLAN_WH_OT MINUTE), :schDate, ACT_TARGET_OT, ACT_TARGET_OT/PLAN_WH_OT) RTT_OT, 
 FIND_RTT_OT(gl.SHIFT_HOURLY_OT2, DATE_ADD(gl.SHIFT_END_HOUR, INTERVAL I.PLAN_WH_X_OT MINUTE), :schDate, ACT_TARGET_X_OT, ACT_TARGET_X_OT/PLAN_WH_X_OT) RTT_X_OT,
I.NORMAL_OUTPUT,  I.OT_OUTPUT, I.X_OT_OUTPUT, I.TOTAL_OUTPUT,  
I.PLAN_EH, I.PLAN_AH, I.PLAN_EH_OT, I.PLAN_AH_OT,  I.PLAN_EH_X_OT, I.PLAN_AH_X_OT,
...
a.SCHD_ID, a.SCH_ID, a.SCHD_PROD_DATE, a.ID_SITELINE,  a.SITE_NAME, f.CUS_NAME, a.LINE_NAME, a.SHIFT, 
IF(SUBSTRING(a.SHIFT ,1,5) = 'Shift', CAST(ROUND(a.SCHD_QTY/2) AS INT), a.SCHD_QTY ) SCHD_QTY,
c.ORDER_REFERENCE_PO_NO, b.SCHD_DAYS_NUMBER, 
c.ORDER_NO, c.CUSTOMER_NAME, c.CUSTOMER_PROGRAM, c.PRODUCT_ITEM_CODE,
c.ITEM_COLOR_CODE,  c.ITEM_COLOR_NAME, c.ORDER_STYLE_DESCRIPTION, 
a.PLAN_SEW_SMV, a.FT_NORMAL, a.LT_NORMAL, a.FT_OT, a.LT_OT,  a.FT_X_OT, a.LT_X_OT,
a.PLAN_MP, a.PLAN_WH, a.ACT_MP, a.PLAN_TARGET, 	a.ACT_TARGET, a.PLAN_WH_X_OT,
a.PLAN_MP_OT, a.PLAN_WH_OT,  a.ACT_MP_OT, 
a.PLAN_TARGET_OT, a.ACT_TARGET_OT,
...
export const QueryDefRateSite = `SELECT a.ENDLINE_SCHD_DATE, a.ENDLINE_ID_SITELINE ID_SITELINE, e.CUS_NAME, e.SITE_NAME, e.SHIFT,
d.CUSTOMER_NAME, d.ORDER_REFERENCE_PO_NO, d.ORDER_STYLE_DESCRIPTION, d.ITEM_COLOR_NAME,
SUM(a.GOOD) AS GOOD, 
SUM(a.CHECKED) AS CHECKED, 
SUM(a.RTT) AS RFT, 
SUM(a.DEFECT) AS DEFECT, 
