...
export const QueryDtlEndChckTblet = `SELECT a.SCHD_PROD_DATE, b.ENDLINE_ID_SITELINE, b.ENDLINE_ACT_SCHD_ID,
 b.ENDLINE_TIME, b.ENDLINE_TIME, n.HOUR_TIME,
b.ENDLINE_PLAN_SIZE, b.CHECKED, b.GOOD, b.RTT, b.DEFECT, b.REPAIRED, b.BS
FROM weekly_prod_sch_detail a
LEFT JOIN (
	SELECT 
	n.ENDLINE_SCHD_DATE, n.ENDLINE_ID_SITELINE,  n.ENDLINE_ACT_SCHD_ID, n.ENDLINE_TIME,
	n.HOUR_TIME,
	n.ENDLINE_PLAN_SIZE,
	IFNULL(n.RTT,0) RTT,
	IFNULL(n.DEFECT, 0) AS DEFECT,
 ...
 FROM (
		 SELECT
			 ...
			 c.ENDLINE_ACT_SCHD_ID,
			 c.ENDLINE_TIME,
			 SEC_TO_TIME(c.ENDLINE_TIME) HOUR_TIME,
			 c.ENDLINE_PLAN_SIZE,
			 SUM(c.RFT) AS RTT,
			 SUM(c.DEFECT) AS DEFECT,
			 SUM(c.REPAIRED) AS REPAIRED,
