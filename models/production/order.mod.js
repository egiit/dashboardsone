...
N.ORDER_QTY, N.ORDER_QTY PRINT_QTY, N.ORDER_SIZE, N.ORDER_STYLE, N.ORDER_REF, N.BARCODE_SERIAL, N.SITE_LINE, 
N.ITEM_COLOR_NAME, N.SITE, N.LINE, NA.SITE_NAME, NA.LINE_NAME   
FROM (
  SELECT DISTINCT a.BUYER_CODE, a.ORDER_NO, a.PRODUCT_TYPE, a.BUYER_PO, a.MO_NO, a.ORDER_VERSION, a.SHIPMENT_DATE,
  ...
  ) b ON b.MO_NO = a.MO_NO -- AND  b.ORDER_PO_id = a.BUYER_PO
  LEFT JOIN (
...
)N LEFT JOIN item_siteline NA ON NA.SITE = N.SITE AND NA.LINE = N.LINE`;
