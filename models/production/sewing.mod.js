...
export const GetQrlistAftrScan = `SELECT a.BARCODE_SERIAL, a.SCH_ID, a.SCHD_ID, b.BUYER_CODE, b.SITE_LINE SITE_LINE_FX, g.SCHD_SITE SITE_NAME, e.LINE_NAME,
...
WHERE g.SCHD_PROD_DATE = :schDate AND a.SEWING_SCAN_LOCATION = :sitename AND a.BARCODE_SERIAL LIKE :barcodeserial`;
