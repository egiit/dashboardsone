...
g.SCHD_PROD_DATE, i.UNDO_RTT, i.UNDO_DEFECT, i.UNDO_BS, i.UNDO_REPAIR
...
export const QueryPlanSizePending = `-- QUERY PLAN SIZEDATA PENNDING
SELECT a.SCH_ID, a.SCHD_ID,  a.PLANSIZE_ID, f.CUSTOMER_NAME BUYER_CODE, e.SITE_NAME, e.LINE_NAME, 
	    ...
	    a.SCHD_PROD_DATE, a.LINE_NAME, a.SITE_NAME, a.ORDER_SIZE, a.COMPLETE_STATUS, l.TFR_QTY, a.BDL_TOTAL,
		 A.QTY, a.RTT, a.DEFECT, a.BS, a.REPAIRED, a.UNDO_RTT, a.UNDO_DEFECT, a.UNDO_BS, a.UNDO_REPAIR,
...
LEFT JOIN viewsewingtfrqty l ON l.SCHD_ID = a.SCHD_ID AND a.ORDER_SIZE = l.ORDER_SIZE AND  f.ITEM_COLOR_NAME = l.ORDER_COLOR
LEFT JOIN (
