...
export const QcEndlineOutput = db.define(
  "qc_endline_output",
  {
    ...
    ENDLINE_SCH_ID: { type: DataTypes.STRING },
    ENDLINE_SCHD_ID: { type: DataTypes.STRING },
...
export const getEndllineQROutput = `SELECT *, M.RTT+M.DEFECT+M.REPAIRED+M.BS AS TOTAL_CHECK  FROM (
...
export const QueryEndlinePlanSize = `SELECT a.SCH_ID, a.SCHD_ID, b.BUYER_CODE, b.SITE_LINE SITE_LINE_FX, g.SCHD_SITE SITE_NAME, e.LINE_NAME,
