...
LEFT JOIN (
    SELECT a.SCHD_PROD_DATE, b.ENDLINE_ID_SITELINE, b.ENDLINE_ACT_SCHD_ID, b.ENDLINE_TIME, b.HOUR_TIME,
...
export const getSewOutDayRepSize = `  SELECT a.SCHD_PROD_DATE ENDLINE_SCHD_DATE, b.ENDLINE_ID_SITELINE, b.ENDLINE_ACT_SCHD_ID, b.ENDLINE_PLAN_SIZE, 
(b.GOOD) GOOD
FROM weekly_prod_sch_detail a
LEFT JOIN viewqcendcheckall b ON a.SCHD_ID = b.ENDLINE_ACT_SCHD_ID 
LEFT JOIN item_siteline c ON a.SCHD_ID_SITELINE = c.ID_SITELINE
