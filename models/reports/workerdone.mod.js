...
b.ORDER_QTY , 1 STEP_ID, SUBSTRING(SUBSTRING_INDEX(b.SITE_LINE,' ',1), 5, 1) SITE, SUBSTRING_INDEX(b.SITE_LINE,' ',1) LINE, b.ORDER_SIZE
...
b.ORDER_QTY , 2 STEP_ID, SUBSTRING(SUBSTRING_INDEX(b.SITE_LINE,' ',1), 5, 1) SITE, SUBSTRING_INDEX(b.SITE_LINE,' ',1) LINE, b.ORDER_SIZE
FROM scan_sewing_in a 
LEFT JOIN order_detail b ON a.BARCODE_SERIAL = b.BARCODE_SERIAL
WHERE DATE(a.SEWING_SCAN_TIME) BETWEEN :startDate AND :endDate
UNION ALL 
SELECT b.BUYER_CODE, a.BARCODE_SERIAL, b.ORDER_NO, b.BUYER_PO, b.MO_NO,  DATE(a.SEWING_SCAN_TIME) SCAN_DATE,  TIME(a.SEWING_SCAN_TIME) SCAN_TIME,
b.ORDER_QTY , 3 STEP_ID, SUBSTRING(SUBSTRING_INDEX(b.SITE_LINE,' ',1), 5, 1) SITE, SUBSTRING_INDEX(b.SITE_LINE,' ',1) LINE, b.ORDER_SIZE
...
b.ORDER_QTY , 4 STEP_ID, SUBSTRING(SUBSTRING_INDEX(b.SITE_LINE,' ',1), 5, 1) SITE, SUBSTRING_INDEX(b.SITE_LINE,' ',1) LINE, b.ORDER_SIZE
