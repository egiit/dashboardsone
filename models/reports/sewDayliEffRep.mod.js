...
I.SCHD_ID, I.SCH_ID, I.SCHD_PROD_DATE, I.ID_SITELINE,  I.SITE_NAME, I.LINE_NAME, I.SHIFT,
 I.ORDER_REFERENCE_PO_NO, I.FOREMAN, I.SCHD_DAYS_NUMBER, I.SCHD_QTY,
...
FROM (
SELECT h.SCHD_ID, h.SCH_ID, h.SCHD_PROD_DATE, h.ID_SITELINE,  h.SITE_NAME, h.LINE_NAME, h.SHIFT, 
         h.ORDER_REFERENCE_PO_NO, h.FOREMAN, h.SCHD_DAYS_NUMBER, h.SCHD_QTY,
        ...
        FROM(
        SELECT n.SCHD_ID, n.SCH_ID, n.SCHD_PROD_DATE, n.ID_SITELINE,  n.SITE_NAME, n.LINE_NAME, n.SHIFT, 
                n.ORDER_REFERENCE_PO_NO, n.FOREMAN, n.SCHD_DAYS_NUMBER, n.SCHD_QTY,
            ...
            FROM (
                    ...
                    m.PLAN_MP_OT, m.PLAN_MP_X_OT, f.PLAN_WH_OT, f.PLAN_WH_X_OT, m.ACT_MP, m.ACT_MP_OT, m.ACT_MP_X_OT, 
                    ...
                    WHERE a.SCHD_PROD_DATE = :schDate  AND  e.SHIFT = :shift  AND d.SITE_NAME = :sitename -- AND e.MP_DATE = :schDate-- AND d.SITE_NAME = 'SBR_01' AND d.LINE_NAME = 'LINE-01'
            )n
        )h
