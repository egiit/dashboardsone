...
ROUND(NULLIF(I.ACTUAL_EH/I.PLAN_AH,0)*100,2) EFF_NORMAL,
ROUND(NULLIF(I.ACTUAL_EH_OT/I.PLAN_AH_OT,0)*100,2) EFF_OT,
ROUND(NULLIF(I.ACTUAL_EH_X_OT/I.PLAN_AH_X_OT,0)*100,2) EFF_X_OT
FROM (
