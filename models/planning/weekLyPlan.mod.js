...
LEFT JOIN  (
	SELECT n.ID_CAP_SIZE, n.SCH_ID, n.SCH_SIZE_ID, n.SIZE_CODE,  n.PACKING_METHOD, sum(n.SCH_SIZE_QTY) SCH_SIZE_QTY
	FROM view_weekly_sch_size n
	WHERE n.ID_CAP_SIZE = CONCAT(SUBSTRING_INDEX(:capId,'.',5),'.', SUBSTRING_INDEX(:capId,'.',-1))
	AND n.SCH_ID = :schId
	GROUP BY n.SCH_ID, n.SIZE_CODE, n.PACKING_METHOD
) nb ON nb.SIZE_CODE = a.SIZE_CODE AND nb.PACKING_METHOD = nb.PACKING_METHOD 
