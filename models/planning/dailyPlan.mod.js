...
export const QueryCheckSchdScan = `	SELECT * FROM (
	...
	b.PRODUCT_ITEM_DESCRIPTION, b.ORDER_STYLE_DESCRIPTION, f.SIZE_CODE, b.PRODUCTION_MONTH, 
...
FROM  (
	...
	LEFT JOIN order_po_listing c ON c.MO_NO = SUBSTRING_INDEX(b.MO_NO,',',-1) AND  b.BUYER_PO = c.ORDER_PO_ID
