export const QueryDailyPlann = `SELECT *, n.PLAN_MP*n.PLAN_WH*60/n.PLAN_SEW_SMV PLAN_TARGET FROM (
	...
	e.PLAN_MP, CASE WHEN ISNULL(f.PLAN_WH) THEN e.PLAN_WH ELSE f.PLAN_WH END PLAN_WH
