...
FROM  (
SELECT DISTINCT a.BARCODE_SERIAL, b.BUYER_CODE, b.ORDER_NO, b.PRODUCT_TYPE, b.BUYER_PO, b.MO_NO, c.ORDER_REFERENCE_PO_NO ORDER_REF,
   ...
   SUBSTRING_INDEX(b.SITE_LINE,' ',1) SITE, SUBSTRING_INDEX(b.SITE_LINE,' ',-1)  LINE
	...
	LEFT JOIN order_po_listing c ON c.ORDER_NO = b.ORDER_NO
